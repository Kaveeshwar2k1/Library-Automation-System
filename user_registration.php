...
if(isset($_POST["register_button"]))
{
	...
	if($message == '')
	{
		...
		else
		{
            ...
            (user_name, user_address, user_contact_no, user_profile, user_email_address, user_password, user_verificaton_code, user_verification_status, user_unique_id, user_status, user_created_on,credit_score) 
            VALUES (:user_name, :user_address, :user_contact_no, :user_profile, :user_email_address, :user_password, :user_verificaton_code, :user_verification_status, :user_unique_id, :user_status, :user_created_on,:credit_score)
			";
			...
			<div class="card-body">
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<br />
						<span class="fw-light">Only .jpg & .png image allowed. Image size must be 225 x 225</span>
					</div>
